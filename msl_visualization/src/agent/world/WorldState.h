...
*/
	 ...
	 */
	Vec rel2abs(const Vec& rel, int robotIdx=0);
	 ...
	 */
	Vec abs2rel(const Vec& abs, int robotIdx=0);
	 ...
	 */
	float lineClear( Vec origin, Vec destiny, int indexToIgnore, float obsIgnoreDist = 0.0, int robotIdx=0);
	...
	bool isLineClear(Vec absPosition, double safetyDist, int indexToIgnore=-1, Vec ownPos = me->pos, float obsIgnoreDist = 0.0, int robotIdx=0);
