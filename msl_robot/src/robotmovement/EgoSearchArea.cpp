...
namespace msl
{
	...
	shared_ptr<EgoSearchArea> EgoSearchArea::getAnArea(double langle, double hangle, double minDist, double maxDist,
	...
	EgoSearchArea::EgoSearchArea(double langle, double hangle, double minDist, double maxDist,
	...
	shared_ptr<vector<shared_ptr<SearchArea>>> EgoSearchArea::expand()
	{
		...
		if (maxDist-minDist < 200) return l;
