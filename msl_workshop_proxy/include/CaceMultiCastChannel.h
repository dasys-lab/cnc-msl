...
namespace multicast
{
	...
	public:
		static long traffic;
		MultiCastChannel(string address, unsigned short port, t_multicastcallback<CommunicationClass> callback,
	...
	template<class CommunicationClass>
	unsigned short MultiCastChannel<CommunicationClass>::sourcePort = 30000;
	template<class CommunicationClass>
	long MultiCastChannel<CommunicationClass>::traffic = 0;

	template<class CommunicationClass>
	inline MultiCastChannel<CommunicationClass>::MultiCastChannel(
	...
	template<class CommunicationClass>
	inline void MultiCastChannel<CommunicationClass>::publish(const char* bytes, int size)
	{
	...
	template<class CommunicationClass>
	void MultiCastChannel<CommunicationClass>::call()
	{
