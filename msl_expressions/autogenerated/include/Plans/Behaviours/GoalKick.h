...
namespace alica
{
	...
	private:
		...
		msl_actuator_msgs::MotionControl rapidAlignToPointWithBall(shared_ptr<geometry::CNPoint2D> egoAlignPoint, shared_ptr<geometry::CNPoint2D> egoBallPos, double angleTolerance, double ballAngleTolerance);
		/*PROTECTED REGION END*/
	};
} /* namespace alica */
