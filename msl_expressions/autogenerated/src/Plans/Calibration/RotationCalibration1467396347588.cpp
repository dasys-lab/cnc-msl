...
namespace alicaAutogenerated
{
     ...
     *		
     * Transition:
     *   - Name: MISSING_NAME, ConditionString: , Comment : Finished Rotation? and Error smaller than 0.02? 
     *
     * Plans in State: 				
    ...
    bool TransitionCondition1470227880114::evaluate(shared_ptr<RunningPlan> rp)
    {
        ...
        return rp->anyChildrenStatus(PlanStatus::Success) && abs(lastRotationCalibError) < CALIB_ERROR_THRESHOLD;
        /*PROTECTED REGION END*/
     ...
     * Vars:
     */
    bool TransitionCondition1470237803034::evaluate(shared_ptr<RunningPlan> rp)
    {
        /*PROTECTED REGION ID(1470237801758) ENABLED START*/
        return rp->anyChildrenStatus(PlanStatus::Success) && abs(lastRotationCalibError) >= CALIB_ERROR_THRESHOLD;
        /*PROTECTED REGION END*/
