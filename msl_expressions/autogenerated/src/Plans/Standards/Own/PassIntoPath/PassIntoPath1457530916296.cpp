...
namespace alicaAutogenerated
{
    ...
    bool TransitionCondition1457531342108::evaluate(shared_ptr<RunningPlan> rp)
    {
		...
		if((pm!=nullptr && pm->senderID>0) || rp->getAssignment()->getRobotStateMapping()->getRobotsInState(1457531293259).size()>0) {
			return true;
		}
		return false;
        /*PROTECTED REGION END*/
    ...
    bool TransitionCondition1457531352472::evaluate(shared_ptr<RunningPlan> rp)
    {
		...
		if(alloBall==nullptr) return true;
		...
		if(egoBall!=nullptr) {
			if(egoBall->length()<1700) return true;
		}
