...
namespace alicaAutogenerated
{
     ...
     * Available Vars:
     */
    bool RunTimeCondition1465474610518::evaluate(shared_ptr<RunningPlan> rp)
    {
        /*PROTECTED REGION ID(1465474610518) ENABLED START*/
        return true;
        /*PROTECTED REGION END*/
    }
...
//        double x = ((msl::MSLWorldModel::get()->field->getFieldWidth() / 2.0) / atan(angle)) - 2300;
        BallXIntervall* us = new BallXIntervall(
                ...
                msl::MSLWorldModel::get()->field->getFieldLength() / 2
                        - msl::MSLWorldModel::get()->field->getGoalAreaLength(),
                1000.0);
     ...
     *   - Plan - (Name): ShovelSelectLowKick, (PlanID): 1435156714286 				
     *   - Plan - (Name): StandardActuateDefault, (PlanID): 1435766278023 				
     *   - Plan - (Name): StandardAlignAndGrabOFKIOH, (PlanID): 1466348438844 
     *
     * Tasks: 
     *   - ExecuteStandard (1439997010902) (Entrypoint: 1464531946025)
     *   - ReceiveStandard (1439997023446) (Entrypoint: 1464532126334)
     ...
     *		
     * Transition:
     *   - Name: MISSING_NAME, ConditionString: , Comment : intercept fail 
     *
     * Plans in State: 				
     *   - Plan - (Name): StandardActuateDefault, (PlanID): 1435766278023 				
     *   - Plan - (Name): ShovelSelectHighKick, (PlanID): 1435156811453 				
     ...
     * Vars:
     */
    bool TransitionCondition1466342189221::evaluate(shared_ptr<RunningPlan> rp)
    {
        /*PROTECTED REGION ID(1466342186872) ENABLED START*/
        return false;
        /*PROTECTED REGION END*/
