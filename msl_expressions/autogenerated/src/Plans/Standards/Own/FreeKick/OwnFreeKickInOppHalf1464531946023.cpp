...
//        double x = ((msl::MSLWorldModel::get()->field->getFieldWidth() / 2.0) / atan(angle)) - 2300;
        BallXIntervall* us = new BallXIntervall(
                ...
                2,
                entryPoints,
				msl::MSLWorldModel::get()->field->getFieldLength() / 3.75,
...
//                && rp->getAssignment()->getRobotStateMapping()->getRobotsInState(1464785237103).size() > 0;
     ...
     *		
     * Transition:
     *   - Name: MISSING_NAME, ConditionString: , Comment : yikes. for unfortunate ball-losses. maybe delete as soon as pass power is tuned nicely. 
     *
     * Plans in State: 				
     *   - Plan - (Name): ShovelSelectHighKick, (PlanID): 1435156811453 				
     *   - Plan - (Name): AlignFreeGoalSpaceDefault, (PlanID): 1467039882734 				
     ...
     * Vars:
     */
    bool TransitionCondition1519832908120::evaluate(shared_ptr<RunningPlan> rp)
    {
        /*PROTECTED REGION ID(1519832906025) ENABLED START*/
        return !wm->ball->haveBall();
        /*PROTECTED REGION END*/
