...
//		double x = ((msl::MSLWorldModel::get()->field->getFieldWidth() / 2.0) / atan(angle)) - 2300;
		BallXIntervall* us = new BallXIntervall(4.0, "OwnFreeKickInOppHalf", 2, entryPoints, 3000.0,
												msl::MSLWorldModel::get()->field->getFieldLength() / 2, 1000.0);
		list<USummand*> utilSummands;
		utilSummands.push_back(us);
		shared_ptr<UtilityFunction> function = make_shared<UtilityFunction>("OwnFreeKickInOppHalfTest", utilSummands,
																			0.1, 0.2, plan);
		return function;
