...
namespace alicaAutogenerated
{
     ...
     *		
     * Transition:
     *   - Name: MISSING_NAME, ConditionString: , Comment : receiver aligned 
     *
     * Plans in State: 				
    ...
    bool TransitionCondition1440772553737::evaluate(shared_ptr<RunningPlan> rp)
    {
        ...
        return rp->anyChildrenStatus(PlanStatus::Success) && rp->getAssignment()->getRobotStateMapping()->getRobotsInState(1441811642575).size() > 0;
        /*PROTECTED REGION END*/
