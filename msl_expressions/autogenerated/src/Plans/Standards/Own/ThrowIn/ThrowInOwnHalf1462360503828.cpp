...
shared_ptr<UtilityFunction> UtilityFunction1462360503828::getUtilityFunction(Plan *plan)
{
    ...
    BallXIntervall *us = new BallXIntervall(3.0, "ThrowInOwnHalf", 3, entryPoints, -(msl::MSLWorldModel::get()->field->getFieldLength() / 2), 2500.0, 1000.0);
    list<USummand *> utilSummands;
    utilSummands.push_back(us);
    shared_ptr<UtilityFunction> function = make_shared<UtilityFunction>("ThrowInNearGoalTest", utilSummands, 0.1, 0.2, plan);
    return function;
