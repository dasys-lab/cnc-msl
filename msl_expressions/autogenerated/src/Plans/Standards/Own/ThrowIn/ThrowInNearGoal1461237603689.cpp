...
namespace alicaAutogenerated
{
    ...
    //State: timeoutForPull in Plan: ThrowInNearGoal

    /*
     *		
     * Transition:
     *   - Name: MISSING_NAME, ConditionString: , Comment : wait for some time 
     *
     * Plans in State: 				
     *   - Plan - (Name): StandardAlignToPointExecutor, (PlanID): 1435155363994 				
     *   - Plan - (Name): ShovelSelectLowKick, (PlanID): 1435156714286 				
     ...
     * Vars:
     */
    bool TransitionCondition1493506056419::evaluate(shared_ptr<RunningPlan> rp)
    {
        /*PROTECTED REGION ID(1493506054296) ENABLED START*/
        return this->isTimeOut(this->rules->getStandbyTime() * 0.11, rp->getStateStartTime(), rp);
        /*PROTECTED REGION END*/
