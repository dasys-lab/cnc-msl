...
namespace alicaAutogenerated
{
    ...
    shared_ptr<UtilityFunction> UtilityFunction1445411471122::getUtilityFunction(Plan* plan)
    {
        ...
        shared_ptr<vector<long>> entryPoints = make_shared<vector<long>>();
		...
		shared_ptr<UtilityFunction> function = make_shared<UtilityFunction>("OtherPlanUtilTest", utilSummands, 0.1, 0.2, plan);
		return function;
