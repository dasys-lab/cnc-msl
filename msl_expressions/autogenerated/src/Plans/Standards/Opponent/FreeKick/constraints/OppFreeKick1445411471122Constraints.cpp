...
//    		TVec* tVec = new TVec{x,y};
//    		shared_ptr<TVec> tVecPtr;
//    		tVecPtr.reset(tVec);
//    		poses.push_back(tVecPtr);

    		poses.push_back(make_shared<TVec>(initializer_list<shared_ptr<Term>>{x,y}));

    		//poses.push_back(make_shared<TVec>(x,y));
