...
//            util = util + msl::MSLConstraintBuilder::approachUtil(tvecBallPose, poses);
        ...
        shared_ptr < TVec > pA = make_shared < TVec > (initializer_list<double> {0,0});
        shared_ptr < TVec > pB = make_shared < TVec > (initializer_list<double> {0, 1000});

        util = util + msl::MSLConstraintBuilder::lineUpUtil(pA, pB, poses);
