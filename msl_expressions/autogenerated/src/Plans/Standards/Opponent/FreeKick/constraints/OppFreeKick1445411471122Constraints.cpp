...
//        cout << "OPFKC: variables  " << c->getDomainVars()->size() << endl;
//        cout << "quant0: " << domainVariables->at(0)->size() << endl;
//        cout << "quant1: " << domainVariables->at(1)->size() << endl;
//        cout << "quant2: " << domainVariables->at(2)->size() << endl;
...
//        shared_ptr < geometry::CNPosition > mopsPose = make_shared < geometry::CNPosition > (-4000, 0, 0);
        ...
        if (mopsPose != nullptr && ballPose != nullptr)
        {
            ...
            cout << "OPFK: norm " << norm->x << "," << norm->y << endl;
            cout << "OPFK: ballPose " << ballPose->x << "," << ballPose->y << endl;
            cout << "OPFK: poseB, poseC " << poseB->x << "," << poseB->y << " | " << poseC->x << "," << poseC->y << endl;
            shared_ptr < geometry::CNPoint2D > blockerBall = ballPose - (vecToBall->normalize() * 3000);
            ...
            util = util + msl::MSLConstraintBuilder::approachUtil(blockerBallTVec, blocker);
