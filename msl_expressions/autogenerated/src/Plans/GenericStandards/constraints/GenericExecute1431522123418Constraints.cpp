...
namespace alicaAutogenerated
{
	 ...
	 */
	void Constraint1457516046535::getConstraint(shared_ptr<ConstraintDescriptor> c, shared_ptr<RunningPlan> rp)
	{
		/*PROTECTED REGION ID(cc1457516046535) ENABLED START*/
		...
		if (opps != nullptr)
		{
			for (auto opp : *opps)
			{
				...
				if (ballPose->distanceTo(blockingPos) > 1800)
				{
