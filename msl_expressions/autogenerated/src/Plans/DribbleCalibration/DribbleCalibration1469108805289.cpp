...
namespace alicaAutogenerated
{
    ...
    //State: CalcParams in Plan: DribbleCalibration

    /*
     *		
     * Transition:
     *   - Name: MISSING_NAME, ConditionString: , Comment : CalcParams finished 
     *
     * Plans in State: 				
     *   - Plan - (Name): CalcDribbleParamsDefault, (PlanID): 1489492271847 
     *
     * Tasks: 
     *   - DefaultTask (1225112227903) (Entrypoint: 1469108805291)
     *
     ...
     * Vars:
     */
    bool TransitionCondition1488285945177::evaluate(shared_ptr<RunningPlan> rp)
    {
        /*PROTECTED REGION ID(1488285941209) ENABLED START*/
        return rp->anyChildrenStatus(alica::PlanStatus::Success);
        /*PROTECTED REGION END*/
     ...
     * Vars:
     */
    bool TransitionCondition1488285976105::evaluate(shared_ptr<RunningPlan> rp)
    {
        /*PROTECTED REGION ID(1488285974466) ENABLED START*/
        return wm->game->checkSituation(msl::Situation::Stop);
        /*PROTECTED REGION END*/
