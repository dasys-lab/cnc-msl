...
//                << defender.size() << endl;
        ...
        msg << "poses, blocker, defender" << poses.size() << " " << blocker.size() << " "
                        << defender.size();
        logger->log("DefendPlay", msg.str(), msl::LogLevels::debug);
        ...
        if (opps != nullptr)
        {
            for (auto opp : *opps)
            {
            	...
            	logger->log("DefendPlay", opp->toString(), msl::LogLevels::debug);
