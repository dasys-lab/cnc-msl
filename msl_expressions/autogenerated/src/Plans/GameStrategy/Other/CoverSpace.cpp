...
namespace alica
{
    ...
    void CoverSpace::run(void* msg)
    {
    	...
    	alloTarget->x = (alloTarget->x+msl::MSLFootballField::FieldLength/2)*positionPercentage - msl::MSLFootballField::FieldLength/2;
    ...
    void CoverSpace::initialiseParameters()
    {
        ...
        if(positionPercentage < 0.1) positionPercentage=0.1;
