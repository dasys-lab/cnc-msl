...
namespace alica
{
	...
	void Actuate::run(void* msg)
	{
		...
		righty=1.8*(sin(x-0.54)-1/9*sin(3*(x+0.16)-0.2)+1/25*sin(5*(x+0.16))-1/49*sin(7*(x+0.16)-0.1));
		lefty =-1.8*(sin(x+2.58)-1/9*sin(3*(x+3.28)-0.2)+1/25*sin(5*(x+3.28))-1/49*sin(7*(x+3.28)-0.1));
