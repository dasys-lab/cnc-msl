...
namespace alica
{
	...
	void Actuate::run(void* msg)
	{
		...
		/////////////////////////////////////////////
			...
			rotationLeft=(-25/M_PI*(atan(rotation/0.001)+M_PI/2))-7/M_PI*(atan(-rotation/0.001)+M_PI/2);
			rotationRight=(-7/M_PI*(atan(rotation/0.001)+M_PI/2))-25/M_PI*(atan(-rotation/0.001)+M_PI/2);
