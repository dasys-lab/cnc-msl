...
namespace alicaAutogenerated
{
    ...
    bool TransitionCondition1426691979272::evaluate(shared_ptr<RunningPlan> rp)
    {
        ...
        return (wm->game->checkSituation(msl::Situation::OwnCorner) || wm->game->checkSituation(msl::Situation::OwnFreekick)
                || wm->game->checkSituation(msl::Situation::OwnGoalkick) || wm->game->checkSituation(msl::Situation::OwnKickoff)
                || wm->game->checkSituation(msl::Situation::OwnThrowin) || wm->game->checkSituation(msl::Situation::OwnPenalty));
        /*PROTECTED REGION END*/
    ...
    bool TransitionCondition1426691980585::evaluate(shared_ptr<RunningPlan> rp)
    {
        ...
        return (wm->game->checkSituation(msl::Situation::OppCorner) || wm->game->checkSituation(msl::Situation::OppFreekick)
                || wm->game->checkSituation(msl::Situation::OppGoalkick) || wm->game->checkSituation(msl::Situation::OppKickoff)
                || wm->game->checkSituation(msl::Situation::OppThrowin) || wm->game->checkSituation(msl::Situation::OppPenalty));
        /*PROTECTED REGION END*/
