...
namespace alicaAutogenerated
{
    ...
    bool TransitionCondition1447255447830::evaluate(shared_ptr<RunningPlan> rp)
    {
    	...
    	if(wm->rawSensorData.getLastMotionCommand() == nullptr && me == nullptr) {
    		return false;
    	}
    	auto translation = wm->rawSensorData.getLastMotionCommand()->motion.translation;
    	auto angle = wm->rawSensorData.getLastMotionCommand()->motion.angle;
    	cout << "GoalieDefault: velocity" << endl;
    	cout << wm->rawSensorData.getLastMotionCommand()->motion << endl;
    	if(translation > 0) {
    		return false;
    	}
    	shared_ptr <geometry::CNPoint2D> goalPos = MSLFootballField::posOwnGoalMid();
    	goalPos->x += 100;
    	auto distanceTo = me->distanceTo(goalPos);
    	cout << "GoalieDefault: distance=" << distanceTo << endl;
		return distanceTo < 100;
        /*PROTECTED REGION END*/
