...
namespace alicaAutogenerated
{
    ...
    bool TransitionCondition1447255447830::evaluate(shared_ptr<RunningPlan> rp)
    {
        ...
        auto lmc = wm->rawSensorData.getLastMotionCommand();

        if (lmc == 0 || me == nullptr)
        {
            cout << "### GoalieDefault ###" << endl;
            cout << " DriveToGoal::me || lastMotionCommand == null!" << endl;
            cout << "### GoalieDefault ###\n" << endl;
            return false;
        }

        double translation = lmc->motion.translation;
        ...
        goalPos->x += 100;
        return me->distanceTo(goalPos) < 100;
        /*PROTECTED REGION END*/
    ...
    bool TransitionCondition1447259463769::evaluate(shared_ptr<RunningPlan> rp)
    {
    	...
    	return  (ballV->x == 0 && ballV->y == 0) && ballX > uLX && (ballY < uLY && ballY > -uLY);*/
    	return false;
        /*PROTECTED REGION END*/
