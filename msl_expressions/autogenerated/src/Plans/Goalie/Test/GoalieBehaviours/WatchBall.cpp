...
//        ballPositions = new InfoBuffer<nonstd::optional<CNPointAllo>>(nrOfPositions);
        //REFACT
...
//        // TODO: Keep?
//
//        if (!alloBall || abs(alloBall->x) > abs(alloGoalMid.x) + 50)
//        {
//
//            /*
...
//
//
//        this->ballPositions->add(make_shared<msl::InformationElement<nonstd::optional<geometry::CNPointAllo>>>(alloBall));
//
//        /*
...
//        {
//            auto currentBall = ballPositions->getLast(i)->getInformation();
...
//            if (i > 2)
//            {
//                ppprevBall = ballPositions->getLast(i - 3)->getInformation();
//                pprevBall = ballPositions->getLast(i - 2)->getInformation();
//                prevBall = ballPositions->getLast(i - 1)->getInformation();
//            }
//
//            if (prevBall && pprevBall && ppprevBall)
//            {
...
//        }
//
//        if (alloBallVel && alloBallVel->x < -1000)
//        {
...
//            {
//                auto curBall = ballPositions->getLast(i)->getInformation();
...
//            calcTargetY = ballPositions->getLast(0)->getInformation()->y;
...
//    {
//        geometry::CNPointAllo alignPoint;
//        double ballAngle = ownPos->getPoint().angleZToPoint(alloTarget) / M_PI * 180;
//
...
//            {
//                alignPoint = geometry::CNPointAllo(ownPos->x + 1000, -((tan(radRotLim) * 1000) - ownPos->y));
//            }
...
//        }
//
//        double angleErr = alignPoint.toEgo(*ownPos).rotateZ(M_PI).angleZ();
