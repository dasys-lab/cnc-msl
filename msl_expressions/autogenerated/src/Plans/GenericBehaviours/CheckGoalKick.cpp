...
namespace alica
{
	...
	CheckGoalKick::CheckGoalKick() :
			DomainBehaviour("CheckGoalKick"), minKickPower(0), toleranceAngle(0), farGoalDist(0), closeGoalDist(0), minObsDistGoal(
					0), keeperDistGoal(0), wheelSpeedLeft(0), wheelSpeedRight(0), cout_kicking(false), cout_kickpower(
					0), field(msl::MSLFootballField::getInstance()), minOwnDistObs(0), minOwnDistGoal(0), waitingIter(0)
	{
	...
	void CheckGoalKick::run(void* msg)
	{
		...
		toleranceAngle = calcToleranceAngle(); // TODO: calcToleranceAngle is buggy
...
//            this->success = true;
		...
		// console output
		cout << "==========================================================================" << endl;
		cout << "hits the goal: " << (hitsGoal(ownPosition->x, ownPosition->y, ownPosition->theta) ? "true" : "false") << endl;
		cout << "tolerance angle: " << toleranceAngle << endl;
		cout << "check line to goal: " << (checkGoalLine() ? "true" : "false")  << endl;
		cout << "check goal keeper: " << (checkGoalKeeper() ? "true" : "false") << endl;
		cout << "check shoot possibility: " << (checkShootPossibility() ? "true" : "false") << endl;
	 ...
	 */
	bool CheckGoalKick::hitsGoal(double posX, double posY, double alloAngle)
	{
