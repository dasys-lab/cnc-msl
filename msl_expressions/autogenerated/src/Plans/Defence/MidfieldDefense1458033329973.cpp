...
namespace alicaAutogenerated
{
    ...
    bool TransitionCondition1458033411271::evaluate(shared_ptr<RunningPlan> rp)
    {
      ...
      std::cout << "Leve block condition? " << (rp->anyChildrenStatus(alica::PlanStatus::Success) ? "true" : "false");
      std::cout << " " << (wm->game.getGameState() == msl::GameState::Duel ? "true" : "false") << std::endl;
