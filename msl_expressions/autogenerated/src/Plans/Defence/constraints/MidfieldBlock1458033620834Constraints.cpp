...
namespace alicaAutogenerated
{
    ...
    void Constraint1458033723845::getConstraint(shared_ptr<ConstraintDescriptor> c, shared_ptr<RunningPlan> rp)
    {
        ...
        shared_ptr < autodiff::TVec > tLeft = make_shared < autodiff::TVec > (initializer_list<double> {left->x,
                                                                                                        left->y});
        shared_ptr < geometry::CNPoint2D > right = freeWayPoint - attacker2ballOrth;
        shared_ptr < autodiff::TVec > tRight = make_shared < autodiff::TVec > (initializer_list<double> {right->x,
                                                                                                         right->y});
		...
		if (ballPos != nullptr && (wm->whiteBoard.getPassMsg() == nullptr || wm->whiteBoard.getPassMsg()->receiverID != wm->getOwnId()))
		{
