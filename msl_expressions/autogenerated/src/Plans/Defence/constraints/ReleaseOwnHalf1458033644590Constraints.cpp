...
//            cout << "ReleaseOwnHalfConstraints: No Attacker EntryPoint found!" << endl;
            logger->log("ReleaseOwnHalfConstraints", "No Attacker EntryPoint found!", msl::LogLevels::error);
...
//            cout << "ReleaseOwnHalfConstraints: No Attacker Position found!" << endl;
            logger->log("ReleaseOwnHalfConstraints", "No Attacker Position found!", msl::LogLevels::error);
            constraint = constraint & ConstraintBuilder::FALSE;
            return;
        }
