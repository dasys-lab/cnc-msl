...
namespace alicaAutogenerated
{
    ...
    bool TransitionCondition1434050620829::evaluate(shared_ptr<RunningPlan> rp)
    {
        ...
        auto right = field->posRightOppGoalPost()->normalize() * dist;
        auto left = field->posLeftOppGoalPost()->normalize() * dist;
        auto ballAllo = ballPos->egoToAllo(*ownPos);
        if (geometry::GeometryCalculator::outsideTriangle(ballAllo, right, left, 450, obs))
        {
...
//		List < TrackedOpponent > opp = wm.GetTrackedOpponents();
     ...
     *		
     * Transition:
     *   - Name: MISSING_NAME, ConditionString: , Comment : IsTimeOut(1500,rp.StateStartTime)) (should be replaced by no obstacles in front)  
     *
     * Plans in State: 				
     *   - Plan - (Name): DribbleControlDefault, (PlanID): 1449742099555 				
