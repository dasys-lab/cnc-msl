...
namespace alicaAutogenerated
{
    ...
    bool TransitionCondition1434050620829::evaluate(shared_ptr<RunningPlan> rp)
    {
        ...
        return (ownPos->x > 0) && (this->wm->game->isMayScore());
        ...
        /*
         ...
         cout << "DRIBBLE: GOAL ANGLE " << goalAng * 180 / M_PI << ", " << abs(goalAng * 180 / M_PI) << endl;
         ...
         return this->robot->kicker->getFreeGoalVector() != nullptr; //&& distance > 1300;
...
//       return ownPos->x > this->wm->field->getFieldLength() / 2.0 - 1300 - this->wm->field->getPenaltyAreaLength();
        return ownPos->x > this->wm->field->getFieldLength() / 4;
...
//        return wm->field->isInsideOppPenalty(ownPos->getPoint(), 200);
     ...
     *		
     * Transition:
     *   - Name: MISSING_NAME, ConditionString: , Comment : ProtectBall opponent is in front of us || not mayscore 
     *
     * Plans in State: 				
     *   - Plan - (Name): DribbleEmergencyKickDefault, (PlanID): 1457706826895 				
     *   - Plan - (Name): DribbleControlMOSDefault, (PlanID): 1479905216821 				
