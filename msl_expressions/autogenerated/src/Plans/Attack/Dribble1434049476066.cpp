...
namespace alicaAutogenerated
{
    ...
    bool TransitionCondition1434050620829::evaluate(shared_ptr<RunningPlan> rp)
    {
        ...
        shared_ptr < geometry::CNPoint2D > goalMid = make_shared < geometry::CNPoint2D > (wm->field.getFieldLength() / 2, 0);
...
//                && abs(ownPos->y) < field->PenaltyAreaWidth / 2.0;
        return wm->field.isInsideEnemyPenalty(ownPos->getPoint(), 200);
        /*PROTECTED REGION END*/
    ...
    bool TransitionCondition1434050650300::evaluate(shared_ptr<RunningPlan> rp)
    {
        ...
        double dang = geometry::deltaAngle(
                ballPos->angleTo(),
                make_shared < geometry::CNPoint2D > (wm->field.getFieldLength() / 2, 0.0)->alloToEgo(*ownPos)->angleTo());
