...
namespace alicaAutogenerated
{
    ...
    void Constraint1508951693560::getConstraint(shared_ptr<ProblemDescriptor> c, shared_ptr<RunningPlan> rp)
    {
        ...
        constraint = constraint
                & msl::MSLConstraintBuilder::outsideArea(msl::Areas::OwnPenaltyArea, passPoint, distanceToFieldBorder);
        ...
        {
            constraint = constraint
                    & msl::MSLConstraintBuilder::outsideSphere(tvecBallPose, minPassDistance, passPoint);
        }
        ...
        if (ballPose)
        {
            ...
            // Lower right corner
            shared_ptr < geometry::CNPoint2D > lrPos = make_shared < geometry::CNPoint2D
                    > (0.0, 2 * msl::Rules::getInstance()->getRobotRadius());
            ...
            // Lower left corner
            shared_ptr < geometry::CNPoint2D > llPos = make_shared < geometry::CNPoint2D
                    > (0.0, 2 * -msl::Rules::getInstance()->getRobotRadius());
