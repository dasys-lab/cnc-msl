...
//            cout << "Attackplay: No Passer Assigned!?!?!?" << endl;
            logger->log("AttackPlayConstraint", "No Passer Assigned!?!?!?", msl::LogLevels::warn);
...
//                    cout << "Attackplay: No Passer Position in WM" << endl;
                    logger->log("AttackPlayCostraint", "No Passer in WM", msl::LogLevels::warn);
                    passerPos = make_shared<geometry::CNPosition>();
                    passer = make_shared < autodiff::TVec > (initializer_list<double> {0, 0});
                }
                break;
...
//            cout << "Attackplay: No Receiver Assigned!?!?!?" << endl;
            logger->log("AttackPlayConstraint", "No Reciver Assigned!?!?!?", msl::LogLevels::warn);
...
//                    cout << "Attackplay: No receiver Position in WM" << endl;
                    logger->log("AttackPlayConstraint", "No reciver Position in WM", msl::LogLevels::warn);
                    receiver = make_shared < autodiff::TVec > (initializer_list<double> {0, 0});
                }
                break;
            }
...
//            cout << "Attackplay: This error should never occure" << endl;
            logger->log("AttackPlayConstraint", "This error should never occure (Stat Variables invalid)", msl::LogLevels::error);
