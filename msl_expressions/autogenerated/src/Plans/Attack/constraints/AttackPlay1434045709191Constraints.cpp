...
namespace alicaAutogenerated
{
    ...
    void Constraint1434112519736::getConstraint(shared_ptr<ConstraintDescriptor> c, shared_ptr<RunningPlan> rp)
    {
        ...
        //Pass should be at least 5m
        constraint = (ConstraintBuilder::distanceSqr(target, receiver) < autodiff::TermBuilder::constant(5000 * 5000));
        ...
        shared_ptr < autodiff::Term > passLength = ConstraintBuilder::distance(target, passer);
        ...
        for (int i = 0; i < opps->size(); i++)
        {
            ...
            constraint = constraint
                    & ConstraintBuilder::distanceSqr(target, oppVecs[i]) > autodiff::TermBuilder::constant(1500 * 1500); //get away from opps
        ...
        util = 100000 - (make_shared < autodiff::Abs > (targetDist - ConstraintBuilder::distance(target, passer)))
                + minOppDist;
        c->setConstraint(dynamic_pointer_cast < alica::SolverTerm > (constraint));
        c->setUtility(dynamic_pointer_cast < alica::SolverTerm > (util));
        /*PROTECTED REGION END*/
