...
namespace alicaAutogenerated
{
    ...
    bool TransitionCondition1434048737070::evaluate(shared_ptr<RunningPlan> rp)
    {
        ...
        for (int i = 0; i < obs->size(); i++)
        {
            ...
            if (temp < distance && obs->at(i)->x < -300 && abs(obs->at(i)->x) < 500)
            {
                distance = temp;
            }
        }
        return wm->ball.haveBall() && distance > 800;
        /*PROTECTED REGION END*/
    ...
    bool TransitionCondition1450175926118::evaluate(shared_ptr<RunningPlan> rp)
    {
        ...
        auto km = wm->kicker.getKickConstrolMsg();
        ...
        double kickVelocity = wm->kicker.getPassVelocity(km->power) / 1000.0;
        ...
        bool result = (isTimeOut(150 * 1000000, rp->getStateStartTime(), rp) && ballDistance < expectedBallTravelDistance / 2.0)
                || isTimeOut(1500 * 1000000, rp->getStateStartTime(), rp);

        std::cout << "StandardAttack: " << (result ? "true" : "false") << std::endl;
        return result;
        /*PROTECTED REGION END*/
