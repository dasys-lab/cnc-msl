...
// RTL8019 data port
#define RTL8019_DATA_PORT           PORTB
#define RTL8019_DATA_DDR            DDRB
#define RTL8019_DATA_PIN            PINB

// RTL8019 control port
#define RTL8019_CONTROL_PORT        PORTC
#define RTL8019_CONTROL_DDR         DDRC
#define RTL8019_CONTROL_READPIN     3
#define RTL8019_CONTROL_WRITEPIN    4
...
#define RTL8019_RESET_PIN 	5

// Use RTL EEPROM to get Ethernet MAC
#define MAC_FROM_EEPROM
