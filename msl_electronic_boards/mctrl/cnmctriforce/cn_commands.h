...
#define CMD_MAX_ACCEL			  0x70
#define CMD_MAX_DECCEL			  0x71
#define CMD_MAX_ROT_FORCE		  0x72
...
void cn_command_controlconf_max_accel(udword* max_accel);
void cn_command_controlconf_max_deccel(udword* max_accel);
void cn_command_controlconf_max_rot_force(udword* max_rot_force);
