...
void cn_command_controlconf_max_accel(udword* bound) {
	controller_params_passive.max_acceleration = *bound;
	controller_params_passive.max_acceleration *= cycle_time;
	controller_params_passive.max_acceleration /= TIME_TICKS_PER_SECOND;
	cn_write_response(GROUP_CONTROL_CONFIG_RES,CMD_MAX_ACCEL,(ubyte*)bound,sizeof(udword));
}
void cn_command_controlconf_max_deccel(udword* bound) {
	controller_params_passive.max_decceleration = *bound;
	controller_params_passive.max_decceleration *= cycle_time;
	controller_params_passive.max_decceleration /= TIME_TICKS_PER_SECOND;
	cn_write_response(GROUP_CONTROL_CONFIG_RES,CMD_MAX_DECCEL,(ubyte*)bound,sizeof(udword));
}
void cn_command_controlconf_max_rot_force(udword* bound) {
	controller_params_passive.max_rot_force = *bound;
	controller_params_passive.max_rot_force *= cycle_time;
	controller_params_passive.max_rot_force /= TIME_TICKS_PER_SECOND;
	cn_write_response(GROUP_CONTROL_CONFIG_RES,CMD_MAX_ROT_FORCE,(ubyte*)bound,sizeof(udword));
}
