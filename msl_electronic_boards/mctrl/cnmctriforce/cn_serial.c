    ...
    case CMD_SET_CYCLE_TIME:
      ...
      break;
		...
		case CMD_TOGGLE_ODO_LOG:
		  ...
		  break;
		case CMD_SET_LOG_MODE:
			cn_command_configure_controller_log((sbyte*)(inbuffer+SERIAL_DATA_POS));
		break;
	    default:
		  cn_command_unknown();
		  break;
...
*/
	...
	case GROUP_CONTROL_CONFIG:
	  switch(inbuffer[SERIAL_CMD_POS]) {
		...
		case CMD_PID_LIN:
			val_sword =  *((sword*) (inbuffer + SERIAL_DATA_POS));
			cn_command_controlconf_pid_lin(&val_sword);
			break;
		case CMD_SMOOTH:
			val_sword =  *((sword*) (inbuffer + SERIAL_DATA_POS));
			cn_command_controlconf_smooth(&val_sword);
			break;

		case CMD_MAX_ROTATION_ACCEL:
			val_uword =  *((uword*) (inbuffer + SERIAL_DATA_POS));
			cn_command_controlconf_max_rotation_accel(&val_uword);
			break;
		...
		case CMD_DEAD_BAND:
			...
			break;
		case CMD_MAX_ERROR_INT:
			val_uword  = *((uword*) (inbuffer + SERIAL_DATA_POS));
			cn_command_controlconf_max_error_int(&val_uword);
			break;			
		...
		case CMD_MAX_ACCEL:
			val_udword =  *((udword*) (inbuffer + SERIAL_DATA_POS));
			cn_command_controlconf_max_accel(&val_udword);
			break;
		case CMD_MAX_DECCEL:
			val_udword =  *((udword*) (inbuffer + SERIAL_DATA_POS));
			cn_command_controlconf_max_deccel(&val_udword);
			break;
		case CMD_MAX_ROT_FORCE:
			val_udword =  *((udword*) (inbuffer + SERIAL_DATA_POS));
			cn_command_controlconf_max_rot_force(&val_udword);
			break;
		...
		case CMD_CURRENT_ERROR_BOUND:
			val_sword = *((sword*) (inbuffer+SERIAL_DATA_POS));
			cn_command_controlconf_current_error_bound(&val_sword);
			break;
		case CMD_CURRENT_KP:
			val_sword = *((sword*) (inbuffer+SERIAL_DATA_POS));
			cn_command_controlconf_current_kp(&val_sword);
			break;
		case CMD_CURRENT_KI:
			val_sword = *((sword*) (inbuffer+SERIAL_DATA_POS));
			cn_command_controlconf_current_ki(&val_sword);
			break;
		case CMD_CURRENT_KD:
			val_sword = *((sword*) (inbuffer+SERIAL_DATA_POS));
			cn_command_controlconf_current_kd(&val_sword);
			break;
