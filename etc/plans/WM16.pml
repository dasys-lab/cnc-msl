...
<alica:Plan xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:alica="http:///de.uni_kassel.vs.cn" id="1413992564408" name="WM16" comment="" destinationPath="Plans" priority="0.0" minCardinality="0" maxCardinality="2147483647" masterPlan="true" utilityFunction="" utilityThreshold="0.1">
  <states id="1413992564409" name="Stop" comment="" entryPoint="1413992564410">
    ...
    <inTransitions>WM16.pml#1426692315498</inTransitions>
    <inTransitions>WM16.pml#1426692322651</inTransitions>
    <inTransitions>WM16.pml#1426692324690</inTransitions>
    <inTransitions>WM16.pml#1426692326813</inTransitions>
    <inTransitions>WM16.pml#1426692328789</inTransitions>
    <inTransitions>WM16.pml#1426692331032</inTransitions>
    <outTransitions>WM16.pml#1426691974126</outTransitions>
    <outTransitions>WM16.pml#1426691976989</outTransitions>
    <outTransitions>WM16.pml#1426691979458</outTransitions>
    <outTransitions>WM16.pml#1426692077573</outTransitions>
    <outTransitions>WM16.pml#1426692164404</outTransitions>
    <outTransitions>WM16.pml#1426692244795</outTransitions>
  </states>
  <states id="1426691835473" name="Gameplay" comment="">
    ...
    <inTransitions>WM16.pml#1426691974126</inTransitions>
    <inTransitions>WM16.pml#1426692306144</inTransitions>
    <inTransitions>WM16.pml#1426692308143</inTransitions>
    <inTransitions>WM16.pml#1426692653093</inTransitions>
    <outTransitions>WM16.pml#1426692324690</outTransitions>
  </states>
  <states id="1426691842031" name="OpponentStandard" comment="">
    ...
    <inTransitions>WM16.pml#1426691979458</inTransitions>
    <outTransitions>WM16.pml#1426692308143</outTransitions>
    <outTransitions>WM16.pml#1426692328789</outTransitions>
  </states>
  <states id="1426691966433" name="OwnStandard" comment="">
    ...
    <inTransitions>WM16.pml#1426691976989</inTransitions>
    <outTransitions>WM16.pml#1426692306144</outTransitions>
    <outTransitions>WM16.pml#1426692326813</outTransitions>
  </states>
  <states id="1426692070119" name="Joystick" comment="">
    ...
    <inTransitions>WM16.pml#1426692077573</inTransitions>
    <outTransitions>WM16.pml#1426692322651</outTransitions>
  </states>
  <states id="1426692157956" name="Parking" comment="">
    <plans xsi:type="alica:Plan">GameStrategy/Other/Parking.pml#1426695119330</plans>
    <inTransitions>WM16.pml#1426692164404</inTransitions>
    <outTransitions>WM16.pml#1426692331032</outTransitions>
  </states>
  <states id="1426692210342" name="DroppedBall" comment="">
    ...
    <inTransitions>WM16.pml#1426692244795</inTransitions>
    <outTransitions>WM16.pml#1426692315498</outTransitions>
    <outTransitions>WM16.pml#1426692653093</outTransitions>
  </states>
  <transitions id="1426691974126" name="MISSING_NAME" comment="situation == start" msg="">
    ...
    <inState>WM16.pml#1413992564409</inState>
    <outState>WM16.pml#1426691835473</outState>
  </transitions>
  <transitions id="1426691976989" name="MISSING_NAME" comment="situation == Own(KickOff || FreeKick || GoalKick || Throwin || Corner || Penality)" msg="">
    ...
    <inState>WM16.pml#1413992564409</inState>
    <outState>WM16.pml#1426691966433</outState>
  </transitions>
  <transitions id="1426691979458" name="MISSING_NAME" comment="situation == Opp(KickOff || FreeKick || GoalKick || Throwin || Corner || Penality)" msg="">
    ...
    <inState>WM16.pml#1413992564409</inState>
    <outState>WM16.pml#1426691842031</outState>
  </transitions>
  <transitions id="1426692077573" name="MISSING_NAME" comment="situation == joystick" msg="">
    ...
    <inState>WM16.pml#1413992564409</inState>
    <outState>WM16.pml#1426692070119</outState>
  </transitions>
  <transitions id="1426692164404" name="MISSING_NAME" comment="situation == parking" msg="">
    ...
    <inState>WM16.pml#1413992564409</inState>
    <outState>WM16.pml#1426692157956</outState>
  </transitions>
  <transitions id="1426692244795" name="MISSING_NAME" comment="situation == dropBall" msg="">
    ...
    <inState>WM16.pml#1413992564409</inState>
    <outState>WM16.pml#1426692210342</outState>
  </transitions>
  <transitions id="1426692306144" name="From Own Standard to GamePlay" comment="anyChildSuccess ||  moreThen7SecondsInStart" msg="">
    ...
    <inState>WM16.pml#1426691966433</inState>
    <outState>WM16.pml#1426691835473</outState>
  </transitions>
  <transitions id="1426692308143" name="MISSING_NAME" comment="anyChildSuccess || moreThen7SecondsInStart" msg="">
    ...
    <inState>WM16.pml#1426691842031</inState>
    <outState>WM16.pml#1426691835473</outState>
  </transitions>
  <transitions id="1426692315498" name="MISSING_NAME" comment="situation  != DropBall &amp;&amp; situation !=start" msg="">
    ...
    <inState>WM16.pml#1426692210342</inState>
    <outState>WM16.pml#1413992564409</outState>
  </transitions>
  <transitions id="1426692322651" name="MISSING_NAME" comment="situation == !joystick" msg="">
    ...
    <inState>WM16.pml#1426692070119</inState>
    <outState>WM16.pml#1413992564409</outState>
  </transitions>
  <transitions id="1426692324690" name="MISSING_NAME" comment="situation != start" msg="">
    ...
    <inState>WM16.pml#1426691835473</inState>
    <outState>WM16.pml#1413992564409</outState>
  </transitions>
  ...
  <transitions id="1426692331032" name="MISSING_NAME" comment="situation != parken " msg="">
    ...
    <inState>WM16.pml#1426692157956</inState>
    <outState>WM16.pml#1413992564409</outState>
  </transitions>
  ...
  <entryPoints id="1413992564410" name="" comment="" successRequired="false" minCardinality="0" maxCardinality="2147483647">
    ...
    <state>WM16.pml#1413992564409</state>
  </entryPoints>
</alica:Plan>
