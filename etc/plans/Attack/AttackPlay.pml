...
<alica:Plan xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:alica="http:///de.uni_kassel.vs.cn" id="1434045709191" name="AttackPlay" comment="" destinationPath="Plans/Attack" priority="0.0" minCardinality="2" maxCardinality="4" masterPlan="false" utilityFunction="" utilityThreshold="1.0E-7">
  <vars id="1457002241973" name="TargetX" comment="" Type=""/>
  <vars id="1457002247256" name="TargetY" comment="" Type=""/>
  <runtimeCondition id="1434112519736" name="NewRuntimeCondition" comment="true" conditionString="" pluginName="DefaultPlugin">
    <vars>Attack/AttackPlay.pml#1457002241973</vars>
    <vars>Attack/AttackPlay.pml#1457002247256</vars>
  </runtimeCondition>
  ...
  <states id="1434045868018" name="MidFieldDefense" comment="" entryPoint="1434045719840">
    ...
    <inTransitions>Attack/AttackPlay.pml#1436536103266</inTransitions>
    <outTransitions>Attack/AttackPlay.pml#1436536098621</outTransitions>
  </states>
  ...
  <states id="1434112762535" name="Release" comment="" entryPoint="1434112675755">
    <parametrisation id="1457002264498" name="MISSING_NAME" comment="">
      ...
      <var>Attack/AttackPlay.pml#1457002241973</var>
    </parametrisation>
    <parametrisation id="1457002272819" name="MISSING_NAME" comment="">
      <subplan xsi:type="alica:Behaviour">Behaviours/MoveToPointDynamic.beh#1456997073100</subplan>
      <subvar>Behaviours/MoveToPointDynamic.beh#1457000426918</subvar>
      <var>Attack/AttackPlay.pml#1457002247256</var>
    </parametrisation>
    <plans xsi:type="alica:Behaviour">Behaviours/MoveToPointDynamic.beh#1456997073100</plans>
    <inTransitions>Attack/AttackPlay.pml#1436536160346</inTransitions>
    <outTransitions>Attack/AttackPlay.pml#1436536148908</outTransitions>
  </states>
  <states id="1436536084172" name="ApproachPass" comment="">
    <plans xsi:type="alica:Behaviour">Attack/CatchPass.beh#1440754525537</plans>
    <plans xsi:type="alica:Behaviour">Dribble/DribbleControl.beh#1449742071382</plans>
    <inTransitions>Attack/AttackPlay.pml#1436536098621</inTransitions>
    <inTransitions>Attack/AttackPlay.pml#1436536101847</inTransitions>
    <outTransitions>Attack/AttackPlay.pml#1436536100248</outTransitions>
    <outTransitions>Attack/AttackPlay.pml#1436536103266</outTransitions>
  </states>
  <states id="1436536085953" name="InterceptPass" comment="">
    ...
    <plans xsi:type="alica:Behaviour">Dribble/DribbleControl.beh#1449742071382</plans>
    <inTransitions>Attack/AttackPlay.pml#1436536100248</inTransitions>
    <outTransitions>Attack/AttackPlay.pml#1436536101847</outTransitions>
  </states>
  <states id="1436536121614" name="InterceptPass" comment="">
    <plans xsi:type="alica:Behaviour">GenericBehaviours/InterceptCarefully.beh#1427703218101</plans>
    <plans xsi:type="alica:Behaviour">Dribble/DribbleControl.beh#1449742071382</plans>
    <inTransitions>Attack/AttackPlay.pml#1436536150744</inTransitions>
    <outTransitions>Attack/AttackPlay.pml#1436536151770</outTransitions>
  </states>
  <states id="1436536123918" name="ApproachPass" comment="">
    <plans xsi:type="alica:Behaviour">Attack/CatchPass.beh#1440754525537</plans>
    <plans xsi:type="alica:Behaviour">Dribble/DribbleControl.beh#1449742071382</plans>
    <inTransitions>Attack/AttackPlay.pml#1436536148908</inTransitions>
    <inTransitions>Attack/AttackPlay.pml#1436536151770</inTransitions>
    <outTransitions>Attack/AttackPlay.pml#1436536150744</outTransitions>
    <outTransitions>Attack/AttackPlay.pml#1436536160346</outTransitions>
  </states>
  <transitions id="1436536098621" name="MISSING_NAME" comment="PassMsg received for OwnID" msg="">
    ...
    <inState>Attack/AttackPlay.pml#1434045868018</inState>
    <outState>Attack/AttackPlay.pml#1436536084172</outState>
  </transitions>
  <transitions id="1436536100248" name="MISSING_NAME" comment="ApproachPass2InterceptPass: rawballconf > x" msg="">
    ...
    <inState>Attack/AttackPlay.pml#1436536084172</inState>
    <outState>Attack/AttackPlay.pml#1436536085953</outState>
  </transitions>
  <transitions id="1436536101847" name="MISSING_NAME" comment="InterceptPass2ApproachPass: PassMsg == null &amp;&amp; GameState==Attack" msg="">
    ...
    <inState>Attack/AttackPlay.pml#1436536085953</inState>
    <outState>Attack/AttackPlay.pml#1436536084172</outState>
  </transitions>
  <transitions id="1436536103266" name="MISSING_NAME" comment="PassMsg == null &amp;&amp; GameState==Attack" msg="">
    ...
    <inState>Attack/AttackPlay.pml#1436536084172</inState>
    <outState>Attack/AttackPlay.pml#1434045868018</outState>
  </transitions>
  <transitions id="1436536148908" name="MISSING_NAME" comment="PassMsg received for OwnID" msg="">
    ...
    <inState>Attack/AttackPlay.pml#1434112762535</inState>
    <outState>Attack/AttackPlay.pml#1436536123918</outState>
  </transitions>
  <transitions id="1436536150744" name="MISSING_NAME" comment="ApproachPass2InterceptPass: rawballconf > x" msg="">
    ...
    <inState>Attack/AttackPlay.pml#1436536123918</inState>
    <outState>Attack/AttackPlay.pml#1436536121614</outState>
  </transitions>
  <transitions id="1436536151770" name="MISSING_NAME" comment="InterceptPass2ApproachPass: PassMsg == null &amp;&amp; GameState==Attack" msg="">
    ...
    <inState>Attack/AttackPlay.pml#1436536121614</inState>
    <outState>Attack/AttackPlay.pml#1436536123918</outState>
  </transitions>
  <transitions id="1436536160346" name="MISSING_NAME" comment="PassMsg == null &amp;&amp; GameState==Attack" msg="">
    ...
    <inState>Attack/AttackPlay.pml#1436536123918</inState>
    <outState>Attack/AttackPlay.pml#1434112762535</outState>
  </transitions>
  <entryPoints id="1434045709194" name="Attack" comment="" successRequired="false" minCardinality="1" maxCardinality="1">
    ...
    <state>Attack/AttackPlay.pml#1434045709193</state>
  </entryPoints>
  <entryPoints id="1434045719840" name="Block" comment="" successRequired="false" minCardinality="0" maxCardinality="1">
    ...
    <state>Attack/AttackPlay.pml#1434045868018</state>
  </entryPoints>
  <entryPoints id="1434045723977" name="Defend" comment="" successRequired="false" minCardinality="0" maxCardinality="1">
    ...
    <state>Attack/AttackPlay.pml#1434045870617</state>
  </entryPoints>
  <entryPoints id="1434112675755" name="ReceivePassInGame" comment="" successRequired="false" minCardinality="1" maxCardinality="1">
    ...
    <state>Attack/AttackPlay.pml#1434112762535</state>
  </entryPoints>
</alica:Plan>
