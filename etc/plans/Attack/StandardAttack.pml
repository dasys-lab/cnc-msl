...
<alica:Plan xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:alica="http:///de.uni_kassel.vs.cn" id="1434046634656" name="StandardAttack" comment="lostBall" destinationPath="Plans/Attack" priority="0.0" minCardinality="1" maxCardinality="1" masterPlan="false" utilityFunction="" utilityThreshold="0.1">
  <states id="1434046634657" name="GetBall" comment="" entryPoint="1434046634658">
    ...
    <inTransitions>Attack/StandardAttack.pml#1434048722503</inTransitions>
    <inTransitions>Attack/StandardAttack.pml#1450175866364</inTransitions>
    <inTransitions>Attack/StandardAttack.pml#1450175921044</inTransitions>
    <inTransitions>Attack/StandardAttack.pml#1457687426425</inTransitions>
    <outTransitions>Attack/StandardAttack.pml#1434048720937</outTransitions>
    <outTransitions>Attack/StandardAttack.pml#1434716047438</outTransitions>
    <outTransitions>Attack/StandardAttack.pml#1450175864724</outTransitions>
  </states>
  <states id="1434048406725" name="Duel" comment="">
    <plans xsi:type="alica:Behaviour">Behaviours/Duel.beh#1450178699265</plans>
    <inTransitions>Attack/StandardAttack.pml#1434048729645</inTransitions>
    <outTransitions>Attack/StandardAttack.pml#1434048734889</outTransitions>
    <outTransitions>Attack/StandardAttack.pml#1457687426425</outTransitions>
  </states>
  <states id="1434048705508" name="HaveBall" comment="">
    <plans xsi:type="alica:Plan">Attack/PassPlay.pml#1436268896671</plans>
    <inTransitions>Attack/StandardAttack.pml#1434048720937</inTransitions>
    <inTransitions>Attack/StandardAttack.pml#1434048734889</inTransitions>
    <inTransitions>Attack/StandardAttack.pml#1434716048579</inTransitions>
    <outTransitions>Attack/StandardAttack.pml#1434048722503</outTransitions>
    <outTransitions>Attack/StandardAttack.pml#1434048729645</outTransitions>
    <outTransitions>Attack/StandardAttack.pml#1434716049424</outTransitions>
    <outTransitions>Attack/StandardAttack.pml#1450175926476</outTransitions>
  </states>
  <states id="1434715893346" name="LostBall" comment="">
    <plans xsi:type="alica:Behaviour">Attack/Wander.beh#1434716215423</plans>
    <inTransitions>Attack/StandardAttack.pml#1434716047438</inTransitions>
    <inTransitions>Attack/StandardAttack.pml#1434716049424</inTransitions>
    <outTransitions>Attack/StandardAttack.pml#1434716048579</outTransitions>
  </states>
  <states id="1450175617600" name="SideLineGetBall" comment="">
    <plans xsi:type="alica:Behaviour">Dribble/DribbleControl.beh#1449742071382</plans>
    <plans xsi:type="alica:Behaviour">Attack/FetchFromSideLine.beh#1450175655102</plans>
    <inTransitions>Attack/StandardAttack.pml#1450175864724</inTransitions>
    <outTransitions>Attack/StandardAttack.pml#1450175866364</outTransitions>
  </states>
  <states id="1450175887984" name="AdvanceAfterPass" comment="">
    <plans xsi:type="alica:Behaviour">Attack/AdvancdeSimplePass.beh#1450176193656</plans>
    <inTransitions>Attack/StandardAttack.pml#1450175926476</inTransitions>
    <outTransitions>Attack/StandardAttack.pml#1450175921044</outTransitions>
  </states>
  <transitions id="1434048720937" name="MISSING_NAME" comment="haveBall" msg="">
    ...
    <inState>Attack/StandardAttack.pml#1434046634657</inState>
    <outState>Attack/StandardAttack.pml#1434048705508</outState>
  </transitions>
  <transitions id="1434048722503" name="MISSING_NAME" comment="lostBall" msg="">
    ...
    <inState>Attack/StandardAttack.pml#1434048705508</inState>
    <outState>Attack/StandardAttack.pml#1434046634657</outState>
  </transitions>
  <transitions id="1434048729645" name="MISSING_NAME" comment="haveBall &amp;&amp; enemy close" msg="">
    ...
    <inState>Attack/StandardAttack.pml#1434048705508</inState>
    <outState>Attack/StandardAttack.pml#1434048406725</outState>
  </transitions>
  <transitions id="1434048734889" name="MISSING_NAME" comment="haveball &amp;&amp; enemy not close" msg="">
    ...
    <inState>Attack/StandardAttack.pml#1434048406725</inState>
    <outState>Attack/StandardAttack.pml#1434048705508</outState>
  </transitions>
  <transitions id="1434716047438" name="MISSING_NAME" comment="doesnt see ball || the opponent in ballpossesion" msg="">
    ...
    <inState>Attack/StandardAttack.pml#1434046634657</inState>
    <outState>Attack/StandardAttack.pml#1434715893346</outState>
  </transitions>
  <transitions id="1434716048579" name="MISSING_NAME" comment="found ball" msg="">
    ...
    <inState>Attack/StandardAttack.pml#1434715893346</inState>
    <outState>Attack/StandardAttack.pml#1434048705508</outState>
  </transitions>
  ...
  <transitions id="1450175864724" name="MISSING_NAME" comment="Ball at sideline and not behind ball and no opponent near Ball" msg="">
    ...
    <inState>Attack/StandardAttack.pml#1434046634657</inState>
    <outState>Attack/StandardAttack.pml#1450175617600</outState>
  </transitions>
  <transitions id="1450175866364" name="MISSING_NAME" comment="SideLineGetBall2GetBall: Ball not at sideline or Fail or opponent near Ball || SideLineGetBall2ApproachBall: Success || dont see the ball" msg="">
    ...
    <inState>Attack/StandardAttack.pml#1450175617600</inState>
    <outState>Attack/StandardAttack.pml#1434046634657</outState>
  </transitions>
  <transitions id="1450175921044" name="MISSING_NAME" comment="KickSomeHowFailed -> We need to reaproach the ball" msg="">
    ...
    <inState>Attack/StandardAttack.pml#1450175887984</inState>
    <outState>Attack/StandardAttack.pml#1434046634657</outState>
  </transitions>
  <transitions id="1450175926476" name="MISSING_NAME" comment="not HaveBallDribble(true) &amp;&amp; PassMsg!=null" msg="">
    ...
    <inState>Attack/StandardAttack.pml#1434048705508</inState>
    <outState>Attack/StandardAttack.pml#1450175887984</outState>
  </transitions>
  ...
  <entryPoints id="1434046634658" name="Attack" comment="" successRequired="false" minCardinality="1" maxCardinality="1">
    ...
    <state>Attack/StandardAttack.pml#1434046634657</state>
  </entryPoints>
</alica:Plan>
