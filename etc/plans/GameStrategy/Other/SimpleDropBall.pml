...
<alica:Plan xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:alica="http:///de.uni_kassel.vs.cn" id="1426696586622" name="SimpleDropBall" comment="" destinationPath="Plans/GameStrategy/Other" priority="0.0" minCardinality="0" maxCardinality="2147483647" masterPlan="false" utilityFunction="" utilityThreshold="0.1">
  <states id="1426696586623" name="Positioning" comment="" entryPoint="1426696586624">
    <plans xsi:type="alica:Plan">GameStrategy/Other/DropBallPositioning.pml#1455537014534</plans>
    <inTransitions>GameStrategy/Other/SimpleDropBall.pml#1458562144787</inTransitions>
    <outTransitions>GameStrategy/Other/SimpleDropBall.pml#1426696640520</outTransitions>
    <outTransitions>GameStrategy/Other/SimpleDropBall.pml#1458562141333</outTransitions>
  </states>
  <states id="1426696626634" name="Execution" comment="">
    <plans xsi:type="alica:Plan">GameStrategy/Other/DropBallExecution.pml#1455537039421</plans>
    <inTransitions>GameStrategy/Other/SimpleDropBall.pml#1426696640520</inTransitions>
    <outTransitions>GameStrategy/Other/SimpleDropBall.pml#1426696641744</outTransitions>
    <outTransitions>GameStrategy/Other/SimpleDropBall.pml#1458562143087</outTransitions>
  </states>
  <states xsi:type="alica:SuccessState" id="1426696638228" name="NewSuccessState" comment="">
    <inTransitions>GameStrategy/Other/SimpleDropBall.pml#1426696641744</inTransitions>
  </states>
  ...
  <states id="1458562124636" name="Wander" comment="">
    ...
    <inTransitions>GameStrategy/Other/SimpleDropBall.pml#1458562141333</inTransitions>
    <inTransitions>GameStrategy/Other/SimpleDropBall.pml#1458562143087</inTransitions>
    <outTransitions>GameStrategy/Other/SimpleDropBall.pml#1458562144787</outTransitions>
  </states>
  <transitions id="1426696640520" name="MISSING_NAME" comment="Situation==start" msg="">
    ...
    <inState>GameStrategy/Other/SimpleDropBall.pml#1426696586623</inState>
    <outState>GameStrategy/Other/SimpleDropBall.pml#1426696626634</outState>
  </transitions>
  <transitions id="1426696641744" name="MISSING_NAME" comment="anychildsuccess" msg="">
    ...
    <inState>GameStrategy/Other/SimpleDropBall.pml#1426696626634</inState>
    <outState>GameStrategy/Other/SimpleDropBall.pml#1426696638228</outState>
  </transitions>
  <transitions id="1458562141333" name="MISSING_NAME" comment="EgoBall==nullptr" msg="">
    ...
    <inState>GameStrategy/Other/SimpleDropBall.pml#1426696586623</inState>
    <outState>GameStrategy/Other/SimpleDropBall.pml#1458562124636</outState>
  </transitions>
  ...
  <transitions id="1458562144787" name="MISSING_NAME" comment="EgoBall!=nullptr" msg="">
    ...
    <inState>GameStrategy/Other/SimpleDropBall.pml#1458562124636</inState>
    <outState>GameStrategy/Other/SimpleDropBall.pml#1426696586623</outState>
  </transitions>
  <entryPoints id="1426696586624" name="MISSING_NAME" comment="" successRequired="true" minCardinality="0" maxCardinality="2147483647">
    ...
    <state>GameStrategy/Other/SimpleDropBall.pml#1426696586623</state>
  </entryPoints>
  <entryPoints id="1455538209889" name="Keeper" comment="" successRequired="false" minCardinality="0" maxCardinality="1">
    ...
    <state>GameStrategy/Other/SimpleDropBall.pml#1455538265766</state>
  </entryPoints>
</alica:Plan>
