...
//		delete udpParser;
	...
	void RefBoxCommunication::connectToHost(void)
	{
...
//		delete udpParser;
	...
	void RefBoxCommunication::processRefBoxMsg()
	{
...
//		}
	...
	void RefBoxCommunication::update_manual_config(void)
	{
...
//		}
	...
	void RefBoxCommunication::apply_Button_pressed(void)
	{
		int new_gamepart = 0;
...
//		}
	...
	void RefBoxCommunication::Timer_start_bot_pressed(void)
	{
//		if (db_coach_info != NULL)
//		{
//			db_coach_info->GameTime.restart();
...
//		}
	...
	void RefBoxCommunication::Timer_stop_bot_pressed(void)
	{
		/*	if(db_coach_info != NULL)
		 {
		 db_coach_info->GamePart = 0;
