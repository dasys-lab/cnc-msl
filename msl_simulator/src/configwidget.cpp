...
ConfigWidget::ConfigWidget()
{
	...
	ADD_VALUE(comm_vars, String, VisionMulticastAddr, "224.5.23.2", "Vision multicast address")
	//SSL Vision: "224.5.23.2"
...
void ConfigWidget::loadRobotSettings(QString team)
{
    ...
    robotSettings.RobotCenterFromKicker = robot_settings->value("Geometery/CenterFromKicker", 0.200).toDouble();
    robotSettings.RobotRadius = robot_settings->value("Geometery/Radius", 0.26).toDouble();
    robotSettings.RobotHeight = robot_settings->value("Geometery/Height", 0.80).toDouble();
    robotSettings.BottomHeight = robot_settings->value("Geometery/RobotBottomZValue", 0.01).toDouble();
    robotSettings.KickerZ = robot_settings->value("Geometery/KickerZValue", 0.110).toDouble();
    robotSettings.KickerThickness = robot_settings->value("Geometery/KickerThickness", 0.005).toDouble();
    robotSettings.KickerWidth = robot_settings->value("Geometery/KickerWidth", 0.10).toDouble();
    robotSettings.KickerHeight = robot_settings->value("Geometery/KickerHeight", 0.20).toDouble();
    robotSettings.WheelRadius = robot_settings->value("Geometery/WheelRadius", 0.065).toDouble();
    robotSettings.WheelThickness = robot_settings->value("Geometery/WheelThickness", 0.04).toDouble();
    robotSettings.Wheel1Angle = robot_settings->value("Geometery/Wheel1Angle", 50).toDouble();
    robotSettings.Wheel2Angle = robot_settings->value("Geometery/Wheel2Angle", 130).toDouble();
    robotSettings.Wheel3Angle = robot_settings->value("Geometery/Wheel3Angle", 230).toDouble();
    robotSettings.Wheel4Angle = robot_settings->value("Geometery/Wheel4Angle", 310).toDouble();

    robotSettings.BodyMass  = robot_settings->value("Physics/BodyMass", 33).toDouble();
    robotSettings.WheelMass = robot_settings->value("Physics/WheelMass", 0.350).toDouble();
    robotSettings.KickerMass= robot_settings->value("Physics/KickerMass", 0.1).toDouble();
    robotSettings.KickerDampFactor = robot_settings->value("Physics/KickerDampFactor", 0.2f).toDouble();
    robotSettings.RollerTorqueFactor = robot_settings->value("Physics/RollerTorqueFactor", 0.18f).toDouble();
    ...
    robotSettings.WheelTangentFriction = robot_settings->value("Physics/WheelTangentFriction", 1.0f).toDouble();
    robotSettings.WheelPerpendicularFriction = robot_settings->value("Physics/WheelPerpendicularFriction", 0.05f).toDouble();
    robotSettings.Wheel_Motor_FMax = robot_settings->value("Physics/WheelMotorMaximumApplyingTorque", 2.0f).toDouble();
