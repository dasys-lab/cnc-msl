...
Ball::Ball(MSLWorldModel *wm, int ringbufferLength)
    ...
    , ballPossessionStatus(BallPossessionStatus::NoBallSeen)
{
                         ...
                         double certainty)
{
    ...
    shared_ptr<InformationElement<geometry::CNPoint2D>> ball =
        make_shared<InformationElement<geometry::CNPoint2D>>(ball2d, time);
    ...
    shared_ptr<InformationElement<geometry::CNVelocity2D>> ballV =
        make_shared<InformationElement<geometry::CNVelocity2D>>(vel2d, time);
