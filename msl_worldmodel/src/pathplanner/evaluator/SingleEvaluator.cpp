...
namespace msl
{
	...
	double SingleEvaluator::eval(double costsSoFar, shared_ptr<vector<shared_ptr<CNPoint2D> > > path, CNPoint2D goal,
...
//		}
		...
		+ nextEdgeLength // cost due to additional length of path
