...
namespace msl
{
    ...
    shared_ptr<vector<geometry::CNPointAllo>> PathPlanner::plan(shared_ptr<VoronoiNet> voronoi,
                                                                geometry::CNPointAllo startPos,
                                                                geometry::CNPointAllo goal,
                                                                shared_ptr<IPathEvaluator> eval)
    {
        ...
        geometry::CNPointAllo closestOpp;
                                    ...
                                    geometry::CNPointAllo obstaclePoint, double obstacleRadius)
    {
        ...
        geometry::CNPointAllo p1 = geometry::CNPointAllo(
        ...
        geometry::CNPointAllo p2 = geometry::CNPointAllo(
                currentPos.x - (this->robotRadius + this->additionalCorridorWidth) * dy,
                currentPos.y + (this->robotRadius + this->additionalCorridorWidth) * dx);
        ...
        return obstaclePoint != nullptr
                && (geometry::distancePointToLine(p2, p4, obstaclePoint) < this->robotRadius
    ...
    bool PathPlanner::corridorCheckBall(geometry::CNPointAllo currentPos,
                                        geometry::CNPointAllo goal,
                                        geometry::CNPointAllo obstaclePoint, double obstacleRadius)
    {
        // calculate length x and y offset
        ...
        dy /= dist;
        // calculate corridor corner points
        geometry::CNPointAllo p1 = geometry::CNPointAllo(currentPos.x + (this->robotRadius) * dy,
                                                                              currentPos.y - (this->robotRadius) * dx);
        geometry::CNPointAllo p2 = geometry::CNPointAllo(currentPos.x - (this->robotRadius) * dy,
                                                                              currentPos.y + (this->robotRadius) * dx);
        geometry::CNPointAllo p3 = geometry::CNPointAllo(
                goal.x
