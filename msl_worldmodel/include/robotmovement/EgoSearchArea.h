...
namespace msl
{
	...
	public:
		...
		void init();
		shared_ptr<EgoSearchArea> getAnArea(double langle, double hangle, double minDist, double maxDist,
	...
	protected:
		EgoSearchArea(double langle, double hangle, double minDist, double maxDist, shared_ptr<geometry::CNPoint2D> center, shared_ptr<geometry::CNPosition> ownPos);
